...
<p>
  <img alt="Version" src="https://img.shields.io/badge/version-1.0.22-blue.svg?cacheSeconds=2592000" />
...
{
  "dependencies": {
    "com.gameframe.gui": "https://github.com/coryleach/UnityGUI.git#1.0.22",
    ...
  },
}
```
